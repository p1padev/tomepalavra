...
function puxar(id) {
  ...
  span.forEach((currentElement) => {
    arrayGuess.push(currentElement.value);
  }); // Passa para o array cada letra;
...
document.addEventListener("keydown", (event) => {
  let botaovisivel = Array.from(document.getElementsByTagName("button")).filter(
    (style) =>
